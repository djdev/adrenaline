        ...
        <div id="landing">
          ...
          <div id="overTheFold">
            <div id="landingHeading">
              <span id="landingTitle">
                Fix your broken code <span>in seconds</span>
              </span>
              <p id="landingSubtitle">
                Stop pasting error messages into Google. Use AI to debug your
                code and teach you along the way.
              </p>
            </div>
            <Button id="getStartedButton" isPrimary onClick={this.onGetStarted}>
              Get started
            </Button>
          </div>
          ...
          <div id="underTheFold">
            <div id="featuresSection">
              <div id="debugFeature">
                <img src="./debug_demo.png" alt="" />
                <div className="featureOverview">
                  <span>Fix your code with one click</span>
                  <p>
                    Input your code and describe the problem, and Adrenaline
                    will propose a fix with just one click.
                  </p>
                </div>
              </div>
              <div id="chatbotFeature">
                <div className="featureOverview">
                  ...
                  <p>
                    For more advanced errors, diagnose them by discussing your
                    code with the Adrenaline chatbot.
                  </p>
                </div>
                <img src="./chatbot_demo.png" alt="" />
              </div>
            </div>
            <div id="pricingSection">
              <div id="subscriptionHeading">
                ...
                <p id="subscriptionSubtitle">
                  Cut StackOverflow out of the loop. Stop wasting time adding
                  print statements to your code.
                </p>
              </div>
