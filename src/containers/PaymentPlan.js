...
export default class PaymentPlan extends Component {
      ...
      return (
        <div className="planFeature">
          <img
            src={
              isSelected
                ? "./checkmark_primary.png"
                : "./checkmark_secondary.png"
            }
            alt=""
          />
          <span>{feature}</span>
  ...
  render() {
    ...
    return (
      <div
        key={planKey}
        className={`paymentPlan ${isSelected ? "isSelected" : ""}`}
      >
        <span
          className={`planLabel ${isSelected ? "isSelected" : ""}`}
        >{`${label} PLAN`}</span>
        ...
        <Button
          ...
          onClick={onClick}
        >
          {isSelected && planKey !== "free_tier" && !notActive
            ? "Unsubscribe"
            : planKey === "free_tier"
            ? "Try it"
            : "Get Started"}
