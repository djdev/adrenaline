      ...
      <div className="buttons">
        <div className="linkButtons">
          <a
            ...
            href="https://discord.gg/jPaJY4Uffb"
            target="_blank"
            rel="noreferrer"
          >
            Discord
          ...
          <a
            ...
            href="https://github.com/shobrook/adrenaline/"
            target="_blank"
            rel="noreferrer"
          >
            Github
        ...
        <div className="ctaButtons">
          {isAuthenticated ? (
            <Button isPrimary onClick={onLogout}>
              Logout
            </Button>
          ) : (
            <>
              <Button id="signUpButton" isPrimary onClick={onSignUp}>
                Sign up
              </Button>
              <Button isPrimary={false} onClick={onLogIn}>
                Log in
              </Button>
            </>
          )}
